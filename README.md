...
| System | CALLHOME | CHAES-eval | CH109 | RT03 | 
| ----------------------------------------------|:--------------:|:-------------:|:------------:|:-------------:| 
| Callhome Diarization Xvector Model            | 6.64% (12.96%) | 1.45% (5.52%) | 2.6% (6.89%) | 0.99% (3.53%) |
| Spectral Clustering COS+B-SC                  | 6.91% (13.23%) | 1.00% (5.07%) | 1.46% (5.75%)| 0.56% (3.1%)  |   
| __Auto-Tuning COS+NME-SC__                    | 5.41% (11.73%) | 0.97% (5.04%) | 1.32% (5.61%)| 0.59% (3.13%) | 
| __Auto-Tuning COS+NMME-SC Sparse-Search-20__  | 5.41% (11.73%) | 0.97% (5.04%) | 1.32% (5.61%)| 0.59% (3.13%) | 
